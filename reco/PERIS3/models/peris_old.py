...
class PERIS(nn.Module):
    ...
    def compute_loss(self, batch_data):
        ...
        loss_pref, hard_neg = self.get_pref_loss(users, items, all_neg_items) # It include the masking operation
        ...
        return loss, loss_IS4debug, loss_pref # loss_IS is a redudant loss so it's okay
