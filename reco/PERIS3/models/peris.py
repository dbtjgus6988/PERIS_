...
class PERIS(nn.Module):
    def __init__(self, opt):
        ...
        trnfront_time = trntimes.max() - 60 * 60 * 24 * 0 * opt.period 
    ...
    def compute_loss(self, batch_data):
        ...
        loss_pref, neg_score = self.get_pref_loss(users, items, all_neg_items) # It include the masking operation
        ...
        return loss, loss_IS4debug, neg_score # loss_IS is a redudant loss so it's okay
