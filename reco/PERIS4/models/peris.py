...
import torch.nn.utils import weight_norm
import math
...
class PERIS(nn.Module):
    def __init__(self, opt):
        ...
        self.ebd_time = TemporalEmbedding(d_model=d_model, embed_type=embed_type,freq=freq) if embed_type != 'timeF' else TimeFeatureEmbedding(d_model=d_model, embed_type=embed_type, freq=freq)
    ...
    def compute_loss(self, batch_data):
        ...
        time_feature = self.ebd_time(
        user_pattern = feature_timebins_user + up_feature + time_feature
